...
tT <- topTable(fit2, adjust.method = "fdr", sort.by = "B", number = 25000)

tT <- subset(tT, select = c("ID", "adj.P.Val", "P.Value", "t", "B", "logFC", "Gene.symbol", "Gene.title"))
write.table(tT, file = 'GSE1297_incipient.tsv', row.names = F, sep = "\t", quote = FALSE)
...
tT <- subset(tT, select = c("ID", "adj.P.Val", "P.Value", "t", "B", "logFC", "Gene.symbol", "Gene.title"))
write.table(tT, file = 'GSE1297_moderate.tsv', row.names = F, sep = "\t", quote = FALSE)
...
tT <- subset(tT, select = c("ID", "adj.P.Val", "P.Value", "t", "B", "logFC", "Gene.symbol", "Gene.title"))
write.table(tT, file = 'GSE1297_severe.tsv', row.names = F, sep = "\t", quote = FALSE)
